...
ifeq ($(DRONE),warpquad)
   ...
   BOARD = cyclone
   FC_FLAGS = -DESC=$(DSHOT) -DDSHOT_RATE=600 -DVBAT -DIBAT -DVBAT_USE_PPM -DMSP_OSD -DBEEPER -DLED=4 #-DOSD -DSMART_AUDIO -DRUNCAM 
   ...
   BOARD = revolution
   FC_FLAGS = -DDUAL_LED_STATUS -DESC=$(DSHOT) -DDSHOT_RATE=600 -DVBAT -DIBAT -DRF #-DOSD -DSMART_AUDIO -DRUNCAM 
endif
