...
add wave -noupdate -radix unsigned /tb_FLIGHT_CTRL_TOP/FLIGHT_CTRL_TOP_inst/SPI_SLAVE_inst/b_cnt
...
add wave -noupdate /tb_FLIGHT_CTRL_TOP/FLIGHT_CTRL_TOP_inst/GYRO_X_rpulse
add wave -noupdate -radix unsigned /tb_FLIGHT_CTRL_TOP/FLIGHT_CTRL_TOP_inst/gyro_x_addr
...
add wave -noupdate -radix unsigned {/tb_FLIGHT_CTRL_TOP/FLIGHT_CTRL_TOP_inst/regw[7]}
add wave -noupdate -radix unsigned {/tb_FLIGHT_CTRL_TOP/FLIGHT_CTRL_TOP_inst/regw[8]}
...
add wave -noupdate -radix unsigned /tb_FLIGHT_CTRL_TOP/FLIGHT_CTRL_TOP_inst/COLLECT_SENSOR_inst/SAMPLE_INDEX
...
add wave -noupdate -radix unsigned {/tb_FLIGHT_CTRL_TOP/FLIGHT_CTRL_TOP_inst/MEM_GYRO_X/mem[0]}
add wave -noupdate -radix unsigned {/tb_FLIGHT_CTRL_TOP/FLIGHT_CTRL_TOP_inst/MEM_GYRO_X/mem[1]}
add wave -noupdate -radix unsigned {/tb_FLIGHT_CTRL_TOP/FLIGHT_CTRL_TOP_inst/MEM_GYRO_Y/mem[0]}
add wave -noupdate -radix unsigned {/tb_FLIGHT_CTRL_TOP/FLIGHT_CTRL_TOP_inst/MEM_GYRO_Y/mem[1]}
add wave -noupdate -radix unsigned {/tb_FLIGHT_CTRL_TOP/FLIGHT_CTRL_TOP_inst/MEM_GYRO_Z/mem[0]}
add wave -noupdate -radix unsigned {/tb_FLIGHT_CTRL_TOP/FLIGHT_CTRL_TOP_inst/MEM_GYRO_Z/mem[1]}
add wave -noupdate -radix unsigned {/tb_FLIGHT_CTRL_TOP/FLIGHT_CTRL_TOP_inst/MEM_ACCEL_X/mem[0]}
add wave -noupdate -radix unsigned {/tb_FLIGHT_CTRL_TOP/FLIGHT_CTRL_TOP_inst/MEM_ACCEL_X/mem[1]}
add wave -noupdate -radix unsigned {/tb_FLIGHT_CTRL_TOP/FLIGHT_CTRL_TOP_inst/MEM_ACCEL_Y/mem[0]}
add wave -noupdate -radix unsigned {/tb_FLIGHT_CTRL_TOP/FLIGHT_CTRL_TOP_inst/MEM_ACCEL_Y/mem[1]}
add wave -noupdate -radix unsigned {/tb_FLIGHT_CTRL_TOP/FLIGHT_CTRL_TOP_inst/MEM_ACCEL_Z/mem[0]}
add wave -noupdate -radix unsigned {/tb_FLIGHT_CTRL_TOP/FLIGHT_CTRL_TOP_inst/MEM_ACCEL_Z/mem[1]}
TreeUpdate [SetDefaultTree]
WaveRestoreCursors {{Cursor 1} {496425631 ps} 0}
...
update
WaveRestoreZoom {346294046 ps} {702741429 ps}
