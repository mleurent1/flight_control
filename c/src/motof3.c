...
__attribute__((section(".RamFunc"))) void I2C2_ER_IRQHandler()
{
...
uint8_t board_init()
{
	...
	// A9 : Gyro (MPU6050) I2C2_SCL (AF4)
	// A10: Gyro (MPU6050) I2C2 SDA (AF4)
	// A11: USB_DM (AF14)
	// A12: USB_DP (AF14)

	// A15: Gyro (MPU6050) interrupt
	...
	// A9 : Gyro (MPU600) I2C2_SCL (AF4)
	// A10: Gyro (MPU600) I2C2_SDA (AF4)
