...
volatile bool rf_busy = false;
volatile bool msp_busy = false;
volatile bool runcam_busy = false;
...
__attribute__((weak)) void rf_transfer(uint8_t* data_out, uint8_t* data_in, uint8_t size_out, uint8_t size_in) {}
__attribute__((weak)) void rf_reset_pin(bool en) {}
__attribute__((weak)) void msp_transfer(uint8_t* data_out, uint8_t* data_in, uint8_t size_out, uint8_t size_in) {}
__attribute__((weak)) void runcam_transfer(uint8_t* data_out, uint8_t* data_in, uint8_t size_out, uint8_t size_in) {}
